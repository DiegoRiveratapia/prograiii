...
@Entity
@Table(name = "Elfo_de_la_noche")
public class ElfoModel {
    @Id
    ...
    public ElfoModel(String nombre,String tipo,Integer danio,Integer salud,Integer armadura,Integer comida){
        this.nombre = nombre;
        this.tipo = tipo;
        this.danio = danio;
        this.salud = salud;
